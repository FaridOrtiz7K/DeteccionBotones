...
class CtrlSAHKManager:
    ...
    def crear_script_ahk(self):
        """Crea automáticamente el script de AutoHotkey para presionar Ctrl+G"""
        ahk_script = """
#Persistent
#SingleInstance force

; Script de AutoHotkey para presionar Ctrl+G múltiples veces
Loop {
...
"""
    ...
    def presionar_ctrl_s(self, veces):  # Cambiado el nombre del método
        ...
        try:
            ...
            logger.info(f"Comando enviado a AHK: Presionar Ctrl+G {veces} veces")
            return True
        except Exception as e:
